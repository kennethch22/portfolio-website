...
import ProjectCard from '@/components/ProjectCard';
  ...
  const socialLinks = [
    { 
      name: "GitHub", 
      url: "https://github.com/kennethch22",
      icon: (
    ...
    { 
      name: "LinkedIn", 
      url: "https://www.linkedin.com/in/kenneth-hendra/",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    { 
      name: "Email", 
      url: "mailto:kennethchristopherhsg@gmail.com",
      icon: (
...
export default async function Home() {
  ...
  const aboutMe = {
    ...
    title: 'Code • Data • Product',
    bio: "I’m Kenneth, a Year 2 Business Analytics student at NUS driven by a passion for solving problems. Whether it's building applications from scratch, extracting actionable insights from complex datasets, or exploring machine learning for predictive modeling, I enjoy leveraging technology to find effective solutions. Outside of academics, I run a marketing agency and enjoy exploring new cuisines and playing clash royale in my free time.",
  };
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid md:grid-cols-2 gap-0 items-center">
            ...
            <div className="space-y-8 flex flex-col justify-center">
              ...
              <p className="text-3xl md:text-xl font-semibold tracking-wide text-cyber-text/90">
                {aboutMe.title}
              </p>
              ...
              <div className="flex gap-4 flex-wrap pt-4">
                ...
                {/* Replace Contact Me button with social icons */}
          {socialLinks.map((social) => (
            <a
              ...
              className="w-12 h-12 glass-card flex items-center justify-center hover:shadow-neon hover:text-cyber-neon-teal transition-all duration-300 group"
              title={social.name}
              aria-label={social.name}
            >
              <div className="text-cyber-text-muted group-hover:text-cyber-neon-teal transition-colors">
                {social.icon}
              </div>
            </a>
          ))}
